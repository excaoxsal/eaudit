...
class M_Temuan extends CI_Model{
    ...
    public function get_temuan_detail($data){
        ...
        if($user_session=="AUDITOR"){
            $sql = '
            SELECT "ID_TEMUAN", "ID_AUDITOR", "ID_LEAD_AUDITOR", "ID_AUDITEE", "ID_ATASAN_AUDITEE", "ID_JADWAL", "ID_RESPONSE", td."STATUS", "KLAUSUL", "PERTANYAAN", "TEMUAN", "APPROVAL_COMMITMENT", "APPROVAL_TINDAKLANJUT", "INVESTIGASI", "PERBAIKAN", "KOREKTIF", "TANGGAL", "KOMENTAR_AUDITOR", "KOMENTAR_AUDITEE", "STATUS_KOMEN_AUDITOR" as "STATUS_KOMEN","KATEGORI","POINT" as "NO","NOMOR_LKHA", d."NAMA_DIVISI"
            FROM "TEMUAN_DETAIL" td
            left join "TM_DIVISI" d on d."KODE" = "SUB_DIVISI"
            where 
                "ID_RESPONSE" = ?
            ORDER BY "ID_TEMUAN",d."NAMA_DIVISI"
            ';
        }else{
            $sql = '
            SELECT "ID_TEMUAN", "ID_AUDITOR", "ID_LEAD_AUDITOR", "ID_AUDITEE", "ID_ATASAN_AUDITEE", "ID_JADWAL", "ID_RESPONSE", td."STATUS", "KLAUSUL", "PERTANYAAN", "TEMUAN", "APPROVAL_COMMITMENT", "APPROVAL_TINDAKLANJUT", "INVESTIGASI", "PERBAIKAN", "KOREKTIF", "TANGGAL", "KOMENTAR_AUDITOR", "KOMENTAR_AUDITEE", "STATUS_KOMEN_AUDITEE" as "STATUS_KOMEN","KATEGORI","POINT" as "NO","NOMOR_LKHA", d."NAMA_DIVISI"
            FROM "TEMUAN_DETAIL" td
            left join "TM_DIVISI" d on d."KODE" = "SUB_DIVISI"
            where 
                "ID_RESPONSE" = ?
