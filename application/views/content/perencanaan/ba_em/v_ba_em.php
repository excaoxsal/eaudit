      ...
      <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          ...
          <div class="card-toolbar">
            <!--begin::Button-->
            <a href="<?= base_url() ?>perencanaan/ba_em/create" class="btn btn-primary font-weight-bolder">
            <i class="fa fa-plus" style="font-size: 12px;"></i>&nbsp;&nbsp;&nbsp;&nbsp;Create Notulen / BA</a>
            <!--end::Button-->
          </div>
        </div>
        <div class="card-body">
...
var KTDatatableJsonRemoteDemo = {
  init: function() {
    ...
    t = $("#datatable").KTDatatable({
      data: {
        type: "remote",
        source: '<?= base_url() ?>perencanaan/ba_em/ba_em_json',
        pageSize: 10
      },
      layout: {
        scroll: !1,
      ...
      columns: [{
        ...
        template: function(t) {
          ...
          return '<a href="<?= base_url() ?>perencanaan/ba_em/create?id='+btoa(t.ID_BA_EM)+'" class="btn btn-sm btn-clean btn-icon" title="Edit"><i class="fa fa-edit"></i></a>'
        }
      }]
    })
  }
