  ...
  <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      <div class="d-flex align-items-center flex-wrap mr-2">
        ...
        <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
        <span class="text-muted font-weight-bold mr-4">RCM</span>
      </div>
    </div>
  </div>
      ...
      <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          <div class="card-title">
            <h3 class="card-label">Risk and Control Matrix
          </div>
        </div>
        <div class="card-body">
...
var KTDatatableJsonRemoteDemo = {
  init: function() {
    ...
    t = $("#kt_datatable").KTDatatable({
      data: {
        type: "remote",
        source: '<?= base_url() ?>perencanaan/rcm/jsonKotakMasukApm',
        pageSize: 10
      },
      layout: {
        scroll: !1,
          ...
          if (t.STATUS == 1) {
            ...
            fa    = "check-circle";
					...
					if (t.STATUS_APPROVER == 1) {
						return '<center><a href="<?= base_url() ?>perencanaan/rcm/review/'+t.ID_RCM+'?review=true&sts-approver='+t.STATUS_APPROVER+'" class="btn btn-sm btn-clean btn-icon" title="Edit"><i class="fa fa-edit text-dark"></i></a></center>';
					} else if (t.STATUS_APPROVER == 2) {
            return '<center><a href="<?= base_url() ?>perencanaan/rcm/review/'+t.ID_RCM+'?review=true&sts-approver='+t.STATUS_APPROVER+'" class="btn btn-sm btn-clean btn-icon" title="View"><i class="fa fa-eye text-dark"></i></a></center>';
