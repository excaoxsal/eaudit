      ...
      <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          <div class="card-title">
            <h3 class="card-label">List Pertanyaan Audit
          </div>
...
var KTDatatableJsonRemoteDemo = {
  init: function() {
    ...
    t = $("#kt_datatable").KTDatatable({
      data: {
        type: "remote",
        source: '<?= base_url() ?>perencanaan/spa/jsonKotakMasukSpa',
        pageSize: 10
      },
      layout: {
        scroll: !1,
      ...
      columns: [{
        ...
        template: function(t) {
          if (t.ID_STATUS == 3) {
              ...
              // return '<span  style="border-radius:0" class="label font-weight-bold label-lg label-light-success label-inline">Terkirim</span>';           
            // }else{
            // }   
        ...
        overflow: "visible",
        template: function(t) {
          if(t.APPROVED_COUNT == t.APPROVER_COUNT){
          return '<center><a href="<?= base_url() ?>perencanaan/spa/review?id='+btoa(t.ID_SPA)+'" class="btn btn-sm btn-clean btn-icon" title="View"><i class="fa fa-eye text-dark"></i></a></center>'
          }else{

          return '<center><a href="<?= base_url() ?>perencanaan/spa/review?id='+btoa(t.ID_SPA)+'" class="btn btn-sm btn-clean btn-icon" title="Edit"><i class="fa fa-edit text-dark"></i></a></center>'
          }
