...
var KTDatatableJsonRemoteDemo = {
  init: function() {
    ...
    t = $("#kt_datatable").KTDatatable({
      data: {
        type: "remote",
        source: '<?= base_url() ?>perencanaan/pka/jsonKotakMasukPka',
        pageSize: 10
      },
      layout: {
        scroll: !1,
      ...
      columns: [{
        ...
        template: function(t) {
          ...
          return '<center><a href="<?= base_url() ?>perencanaan/pka/review/'+t.ID_PKA+'?review=true" class="btn btn-sm btn-clean btn-icon" title="View"><i class="fa fa-eye text-dark"></i></a></center>'
          }else{
          return '<center><a href="<?= base_url() ?>perencanaan/pka/review/'+t.ID_PKA+'?review=true" class="btn btn-sm btn-clean btn-icon" title="Edit"><i class="fa fa-edit text-dark"></i></a></center>'
          }
        }
      }]
