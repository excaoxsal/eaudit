      ...
      <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          ...
          <div class="card-toolbar">
            <a href="<?= base_url() ?>perencanaan/pka/create" class="btn btn-primary font-weight-bolder">
            <i class="fa fa-plus" style="font-size: 12px;"></i>&nbsp;&nbsp;&nbsp;&nbsp;Create PKA</a>
          </div>
        </div>
        <div class="card-body">
...
var KTDatatableJsonRemoteDemo = {
  init: function() {
    ...
    t = $("#kt_datatable").KTDatatable({
      data: {
        type: "remote",
        source: '<?= base_url() ?>perencanaan/pka/jsonKotakKeluarPka',
        pageSize: 10
      },
      layout: {
        scroll: !1,
      ...
      columns: [{
        ...
        overflow: "visible",
        template: function(t) {
          // return '<a href="<?= base_url() ?>perencanaan/kotak_keluar/pka/create/'+t.ID_PKA+'" class="btn btn-sm btn-clean btn-icon" title="Edit"><i class="fa fa-edit"></i></a>'
          if (t.ID_STATUS == 1 || t.ID_STATUS == 4) {     
            return '<a href="<?= base_url() ?>perencanaan/pka/create/'+t.ID_PKA+'" class="btn btn-sm btn-clean btn-icon" title="Edit"><i class="fa fa-edit text-dark></i></a>';
          }else {
            return '<a href="<?= base_url() ?>perencanaan/pka/create/'+t.ID_PKA+'" class="btn btn-sm btn-clean btn-icon" title="View"><i class="fa fa-eye text-dark"></i></a>'
          }
        }
      }]
