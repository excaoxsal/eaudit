      ...
      <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          <div class="card-title">
            <h3 class="card-label">Audit Planning Memorandum</h3>
          </div>
          <div class="card-toolbar">
            <a href="<?= base_url() ?>perencanaan/apm/create" class="btn btn-primary font-weight-bolder">
            <i class="fa fa-plus" style="font-size: 12px;"></i>&nbsp;&nbsp;&nbsp;&nbsp;Create APM</a>
          </div>
        </div>
        <div class="card-body">
      ...
      columns: [{
        ...
        template: function(t) {
          ...
          if (t.ID_STATUS == 1 || t.ID_STATUS == 4) {			
						return '<a href="<?= base_url() ?>perencanaan/apm/create/'+t.ID_APM+'" class="btn btn-sm btn-clean btn-icon" title="Edit"><i class="fa fa-edit text-dark"></i></a>';
					}else {
						return '<a href="<?= base_url() ?>perencanaan/apm/create/'+t.ID_APM+'" class="btn btn-sm btn-clean btn-icon" title="Edit"><i class="fa fa-eye text-dark"></i></a>'
					}
        }
      }]
