          ...
          <table class="table table-bordered table-hover table-checkable dataTable no-footer dtr-inline">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center"><a href="#" class="btn btn-sm btn-clean btn-icon" title=""><i class="fa fa-eye"></i></a><a href="#" class="btn btn-sm btn-clean btn-icon" title="Edit"><i class="fa fa-edit"></i></a><a href="javascript:;" class="btn btn-sm btn-clean btn-icon" title="Delete"><i class="fa fa-trash"></i></a><a href="#" class="btn btn-sm btn-clean btn-icon" title=""><i class="fa fa-download"></i></a></td>
              </tr>
              <tr>
                <td>2</td>
                <td>XXX/XXX/XXXX</td>
