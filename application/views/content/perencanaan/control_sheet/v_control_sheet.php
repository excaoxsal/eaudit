...
var KTDatatableJsonRemoteDemo = {
  init: function() {
    ...
    t = $("#kt_datatable").KTDatatable({
      data: {
        type: "remote",
        source: '<?= base_url() ?>perencanaan/control_sheet/spa_json',
        pageSize: 10
      },
      layout: {
        scroll: !1,
      ...
      columns: [{
        ...
        overflow: "visible",
        template: function(t) {
						return '<center><a href="<?= base_url() ?>perencanaan/control_sheet/create?id='+btoa(t.ID_SPA)+'" class="btn btn-sm btn-primary" title="Control Sheet">Update</a></center>'	
        }
      }]
