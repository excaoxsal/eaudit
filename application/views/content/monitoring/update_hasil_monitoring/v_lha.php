    ...
    init: function() {
      ...
      t = $("#datatable").KTDatatable({
        ...
        columns: [{
          ...
          overflow: "visible",
          template: function(t) {
            return '<a href="<?= base_url() ?>monitoring/update_hasil_monitoring/tindak_lanjut/' + t.ID_TL + '" class="btn btn-sm btn-clean btn-icon" title="Tindak Lanjut"><i class="text-dark fa fa-file-import"></i></a><a onclick="preview(' + t.TAHUN + ',' + t.ID_DIVISI + ', ' + t.ID_JENIS_AUDIT + ')" class="btn btn-sm btn-clean btn-icon" title="Preview"><i class="text-dark fa fa-eye"></i></a>'
          }
        }]
      });
      ...
      if (result.value) {
        ...
        Swal.fire({
          ...
          if (result.dismiss === Swal.DismissReason.timer) {
            window.location.href = "<?php echo base_url() ?>" + 'monitoring/update_hasil_monitoring/hapus_lha/' + id;
          }
        })
      }
    })
