    ...
    <div class="container">
      ...
      <div class="card card-custom">
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            <label class="col-form-label col-3 text-left">ISO</label>
            <div class="col-8">
              <input type="text" <?= $disabled ?> value="<?= $data_apm->NAMA_AUDIT ?>" class="form-control" name="NAMA_AUDIT" id="NAMA_AUDIT" placeholder="ISO">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-form-label col-3 text-left">Klausul</label>
            <div class="col-8">
              <input type="text" <?= $disabled ?> value="<?= $data_apm->NAMA_AUDIT ?>" class="form-control" name="NAMA_AUDIT" id="NAMA_AUDIT" placeholder="Klausul">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            <label class="col-form-label col-3 text-left">Klasifikasi</label>
            <div class="col-8">
              <input type="text" <?= $disabled ?> value="<?= $data_apm->NAMA_AUDIT ?>" class="form-control" name="NAMA_AUDIT" id="NAMA_AUDIT" placeholder="Klasifikasi">
            </div>
          </div>

          <!-- <h6 class="text-left my-10 mt-20">Tujuan dan Ruang Lingkup Audit</h6> -->
          <div class="form-group row">
            <label class="col-form-label col-3 text-left">Pertanyaan Audit</label>
            <div class="col-8">
