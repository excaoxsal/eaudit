      ...
      <div class="card card-custom">
        <div class="card-body">
          ...
          <div class="d-flex justify-content-end"> <!-- Gunakan justify-content-end -->
            <btn class="btn btn-success" onclick="approve(123)" id="approve-btn">Approve</btn>
            <btn class="btn btn-danger" id="reject-btn">Reject</btn>
          </div>
        </div>
      </div>
    </div>
        ...
        const tableHTML = `
          <div class="grouped-master-section">
            <div class="d-flex align-items-center flex-wrap">
              <div class="grouped-master-title">Potensi Temuan</div>
            </div>
...
function approve() {
  ...
  Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = '<?= base_url() ?>aia/Potensi_temuan/approve/' + this.id_response;
