  ...
  init: function() {
    ...
    t = $("#kt_datatable").KTDatatable({
      ...
      },
      {
          ...
          overflow: "visible",
          template: function(t) {
            return '<a  href="<?= base_url() ?>aia/response_auditee/detail/'+t.ELCODING+'" class="btn btn-sm btn-clean btn-icon" title="Lihat"><i class="fa fa-eye text-dark"></i></a><a  href="<?= base_url() ?>aia/response_auditee/export_excel/'+t.ELCODING+'" class="btn btn-sm btn-clean btn-icon" title="Export"><i class="fa fa-download text-dark"></i></a>'
