...
<ul class="menu-nav">
      ...
      <div class="menu-submenu">
        ...
        <ul class="menu-subnav">
          ...
          <li class="menu-item <?= isset($sub_menu) ? $sub_menu == 'jabatan' ? 'menu-item-active' : '' : ''; ?>" aria-haspopup="true">
            <a href="<?= base_url() ?>aia/master/jabatan" class="menu-link mx-5 my-1 rounded">
    ...
    <li  id="myList"  class="menu-item menu-item-submenu <?= isset($menu) ? $menu == 'temuan-aia' ? 'menu-item-open menu-item-here' : '' : ''; ?>" aria-haspopup="true" data-menu-toggle="hover">
      ...
      <div class="menu-submenu">
        <i class="menu-arrow"></i>
        <ul class="menu-subnav">
          <li class="menu-item menu-item-submenu <?= isset($sub_menu) ? $sub_menu == 'temuan-aia' ? 'menu-item-open menu-item-here' : '' : ''; ?>" aria-haspopup="true">
    ...
    <li class="menu-item <?= isset($menu) ? $menu == 'dashboard' ? 'menu-item-active' : '' : ''; ?>" aria-haspopup="true">
      <a href="<?= base_url('aia/Dashboard') ?>" class="menu-link mx-5 my-1 rounded">
