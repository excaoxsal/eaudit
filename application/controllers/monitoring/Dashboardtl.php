...
class Dashboardtl extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('/content/monitoring/v_dashboard_monitoring', $data);
    }
    ...
    public function data($year, $divisi)
    {
        ...
        $dataEntry          = $this->m_rekap->getEntryDashboard($year, $divisi);
        $report             = array();
        $i                  = 0;
        $total_temuan       = 0;
        $total_rekomendasi  = 0;
